...
The easing plugin is included, if you want to use some of thier transition effects, but it is not required for ceebox to work.
...
h3. 2.0.1 Major Upgrade BETA _this has been tested on all major browsers but needs to be tested further_
...
* Even with all this additional functionality the size is only 11.6KB compressed.
